...
class LauncherApp(tk.Tk):
    ...
    def _open_request_dialog(self):
        ...
        Uses the browser-based dialog if pywebview is available.
        Falls back to the place ID lookup dialog if not — also opens
        roblox.com/charts in Firefox so the child can find games to request.
        """
        try:
            import webview
